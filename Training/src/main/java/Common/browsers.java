...
public class browsers {
  ...
  public void beforeClass(String wbsite, String br) {
			 if(br.equalsIgnoreCase("chrome")){
				 System.setProperty("webdriver.chrome.driver", "C:\\Users\\12408\\Downloads\\Training-20200223T151848Z-001\\Training\\Drivers\\chromedriver.exe");
			  driver=new ChromeDriver();
			  driver.navigate().to(wbsite);
			 driver.manage().window().maximize();
		  }else if(br.equalsIgnoreCase("firefox")) {
			  System.setProperty("webdriver.gecko.driver", "C:\\Users\\12408\\Downloads\\Training-20200223T151848Z-001\\Training\\Drivers\\geckodriver.exe");
